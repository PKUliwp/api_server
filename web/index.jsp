...
<%
    ...
    for(int i=0;i<5;i++) {
        ...
        element[i] = "<div style=\"float:left;position:relative;width:15%;\">" + entity.name() +
                ...
                "<input style=\"float:left;width:4%;\" type=\"submit\" value = \"Q&A\" form=\"qa\" " +
                "name=\"qa" + i + "\"" +
                "/>" +
                "<br/>";
    ...
    String so = "<form id=\"qa\" method=\"post\" target=\"show\" action=\"http://localhost:9090/api/qa_show.jsp\">";
    for(int i=0;i<5;i++) {

        so += "<input type=\"text\" style=\"display:none\" name=\"value" +
                i + "\" value=\"" +
